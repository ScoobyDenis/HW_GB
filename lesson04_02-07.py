...
l = [15, -11, 56, 28, -13, 1, 0, 777]
print(l)
new_list = [l[i] for i in range(len(l)-1) if l[i+1] < l[i]]
if l[-1] > l[-2]:
     new_list.append(l[-1])
print(new_list)
...
print([i for i in lis if lis.count(i) < 2])
...
for el in count(3, 5.275):
    print(round(el, 2), end=" ")
    if el > 50:
        break
print()
i = 0
for el in cycle("_Maria_Thanks"):
    print(el, end=" ")
    i += 1
    if i == 53:
        break
...
for elem in fact(n):
    print(elem)
    l.append(elem)
print("Факториал числа",n, "равен -", l[-1])
